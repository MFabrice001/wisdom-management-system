...
export default function CitizenConversationPage({ params }) {
  ...
  if (!session) {
    return <div className={styles.accessDenied}>Please log in.</div>;
  }
    ...
    <div className={styles.page}>
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          <Link href="/citizen/messages" className={styles.backButton}>
            <ArrowLeft size={20} />
          </Link>
